module.exports = function (app) {
  (function () {
    ...
    app.models['files'].belongsTo(app.models['domains'], { as: 'domain' })         // makes files.domainId
    app.models['domains'].hasMany(app.models['files'])
    app.models['files'].belongsTo(app.models['users'], { as: 'user' })             // makes files.userId
  })(app)
}
